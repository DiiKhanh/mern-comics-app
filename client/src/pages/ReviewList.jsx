  ...
  return (
    <Box sx={{
      ...
      <Box sx={{ width: { xs: 0, md: '10%' } }}>
        <Link
          to={routesGen.comicDetail(review.comicId)}
          style={{ color: 'unset', textDecoration: 'none' }}
        >
          <Box sx={{
            paddingTop: '160%',
            ...uiConfigs.style.backgroundImage(review.comicThumbnail)
          }} />
        </Link>
      </Box>
  ...
  return (
    <Helmet title={'Reviews'}>
      <Box sx={{ ...uiConfigs.style.mainContent }}>
        <ContainerBox header={`Your reviews (${count})`} icon={<RateReviewIcon />}>
          <Stack spacing={2}>
